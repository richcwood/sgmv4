...
// todo - create a permanent JWT for this account - Rich can do this pretty quickly
  ...
  const authToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..RZw8rQ2AHzJIlGlGnN3dbgDjD-xE61ODR_ZWRWI7kBM'; // this is a very limited demo account that is monitored
  ...
  export default defineComponent({
      ...
      async mounted() {
          ...
          if (!import.meta.env.SSR) {
            ...
            this.monacoModelListener = monaco.editor.onDidCreateModel((model: editor.ITextModel) => {
