        ...
        <div class="container content">
            <div class="columns is-size-5-desktop is-size-6-touch">
                ...
                <article class="column is-7 px-5">
                    ...
                    <h2 class="subtitle is-size-4-desktop is-size-5-touch">What is SaaSGlue?</h2>
                    ...
                    <h2 class="subtitle is-size-4-desktop is-size-5-touch">Features</h2>
                    ...
                    <h2 class="subtitle is-size-5-desktop is-size-6-touch">Logging</h2>
                    ...
                    <h2 class="subtitle is-size-5-desktop is-size-6-touch">Notifications</h2>
                    ...
                    <h2 class="subtitle is-size-5-desktop is-size-6-touch">Sequential Job Execution</h2>
                    ...
                    <h2 class="subtitle is-size-5-desktop is-size-6-touch">Reliable and Secure</h2>
                    <p>Our service is built to be reliable and secure, so you can trust it to handle your important automation tasks with care. We use the latest security practices to ensure that your data is safe and protected.</p>

                    <h2 class="subtitle is-size-5-desktop is-size-6-touch">Scalable</h2>
                    ...
                    <h2 class="subtitle is-size-5-desktop is-size-6-touch">Import your existing Cron jobs</h2>
